...
Nesse projeto, desenvolvi uma aplicação com Vite (typescript) no interesse de aprender sobre a tecnologia. Apesar de serem poucas funcionalidades a aplicação é para gerenciar um carrinho de compras de uma cafeteria fictícia, que contém as seguintes funcionalidades:
